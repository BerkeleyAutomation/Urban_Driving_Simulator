...
class GeometricPlanner:
    ...
    def plan(self,x0,y0,v0,a0,x1,y1,v1,a1):
        ...
        p0 = [x0,y0]
        p1 = [x0+.4*distance_between_points*np.cos(a0), y0 - .4*distance_between_points*np.sin(a0)]
        p2 = [x1-.4*distance_between_points*np.cos(a1), y1 + .4*distance_between_points*np.sin(a1)]
        p3 = [x1,y1]
